...
def get_icosphere():
    ...
    tnorm = 1.0/np.sqrt(1 + t*t)

    vertices = []
    vertices.append(tnorm*np.array((-1, t, 0)))
    vertices.append(tnorm*np.array(( 1, t, 0)))
    vertices.append(tnorm*np.array((-1,-t, 0)))
    vertices.append(tnorm*np.array(( 1,-t, 0)))

    vertices.append(tnorm*np.array(( 0,-1, t)))
    vertices.append(tnorm*np.array(( 0, 1, t)))
    vertices.append(tnorm*np.array(( 0,-1,-t)))
    vertices.append(tnorm*np.array(( 0, 1,-t)))

    vertices.append(tnorm*np.array(( t, 0,-1)))
    vertices.append(tnorm*np.array(( t, 0, 1)))
    vertices.append(tnorm*np.array((-t, 0,-1)))
    vertices.append(tnorm*np.array((-t, 0, 1)))
